...
def main():
    print('')
    print('replace_by_source_replicator_multipoint.py start...')
    ...
    lx.eval('@{scripts/replace_by_replicator_multipoint.py}')

    print('replace_by_source_replicator_multipoint.py done.')

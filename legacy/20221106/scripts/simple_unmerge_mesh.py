...
from mesh_islands_to_items import get_tmp_name, modo_unmerge, group_similar_items, group_equal_meshes, DetectOptions
...
def main():
    ...
    todo_meshes = modo_unmerge(meshes=selected_meshes, largest_rot=largest_rot, largest_pos=largest_pos)
